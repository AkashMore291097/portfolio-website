...
export const profile: Profile = {
  ...
  resumePath: "https://drive.google.com/file/d/1V0spk3mW7IjdV1mowPytSElJr-PWmAqs/view?usp=sharing",
  location: "Mumbai",
  timezone: "IST",
  timezoneId: "Asia/Kolkata",
  updatedMonth: "September 2026",
  aboutParagraph: "Software Engineer with 5+ years of experience building and supporting backend and full-stack applications using Node.js, Express.js, React.js, MySQL, Redis, Python and FastAPI. Experienced in application architecture, REST API development, microservices, database optimization, third-party integrations, AWS deployment and production support. Currently expanding into Generative AI and Agentic AI, building applications with Python, FastAPI, LLM APIs, RAG, LangChain, LangGraph and vector databases.",
